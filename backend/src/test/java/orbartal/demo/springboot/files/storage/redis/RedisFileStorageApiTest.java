...
@SpringBootTest(
		...
		//Redis config to run embeded redis
		classes = TestRedisConfiguration.class, 
		//Over write the property to make use redis to store file metadata
		properties = {"file.storage.service=redis"}
)
public class RedisFileStorageApiTest {
